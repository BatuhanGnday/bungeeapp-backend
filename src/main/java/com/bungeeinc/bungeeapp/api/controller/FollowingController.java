...
public class FollowingController {
    ...
    @GetMapping("/list")
    public GetFollowingsResponse getFollowings(@RequestParam(value = "user_id") int id, @ActiveUser User user) {
    ...
    @GetMapping("/outgoing")
    public GetFollowingsResponse outgoingRequests(@ActiveUser User user) {
